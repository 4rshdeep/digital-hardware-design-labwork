...
HD_PWD='/media/ad/Area51/workspace/col215_prac_lab/vivado/lab5/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5_gcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab5_gcd.tcl -notrace
