...
HD_PWD='/media/ad/Area51/workspace/col215_prac_lab/vivado/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5_gcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab5_gcd.tcl
