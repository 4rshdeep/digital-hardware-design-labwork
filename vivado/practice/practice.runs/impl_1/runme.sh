...
HD_PWD='/media/ad/TheLibrary/col215_lab/vivado/practice/practice.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab6_multiplier.tcl -notrace
