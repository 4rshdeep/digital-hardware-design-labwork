...
set rc [catch {
  ...
  open_checkpoint lab8_elevator_control_routed.dcp
  set_property webtalk.parent_dir /media/ad/Area51/workspace/col215_prac_lab/vivado/practice/practice.cache/wt [current_project]
