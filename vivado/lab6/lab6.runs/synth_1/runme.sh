...
HD_PWD='/media/ad/Area51/workspace/col215_prac_lab/vivado/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cla_adder_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cla_adder_8.tcl
