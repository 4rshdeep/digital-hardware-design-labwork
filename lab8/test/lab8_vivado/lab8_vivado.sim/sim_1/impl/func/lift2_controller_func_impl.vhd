...
-- Date        : Sun Oct 15 22:15:50 2017
-- Host        : ad-ubuntu running 64-bit Ubuntu 16.04.3 LTS
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               /media/ad/Area51/workspace/col215_prac_lab/lab8/test/lab8_vivado/lab8_vivado.sim/sim_1/impl/func/lift2_controller_func_impl.vhd
...
entity lab8_elevator_control is
  ...
  attribute ECO_CHECKSUM of lab8_elevator_control : entity is "f89042fe";
...
\down_request_indicator_OBUF[1]_inst\: unisim.vcomponents.OBUFT
     port map (
      I => '0',
      O => down_request_indicator(1),
      T => '1'
    );
\down_request_indicator_OBUF[2]_inst\: unisim.vcomponents.OBUFT
     port map (
      I => '0',
      O => down_request_indicator(2),
      T => '1'
    );
\down_request_indicator_OBUF[3]_inst\: unisim.vcomponents.OBUFT
     port map (
      I => '0',
...
\up_request_indicator_OBUF[0]_inst\: unisim.vcomponents.OBUFT
     port map (
      I => '0',
      O => up_request_indicator(0),
      T => '1'
    );
\up_request_indicator_OBUF[1]_inst\: unisim.vcomponents.OBUFT
     port map (
      I => '0',
      O => up_request_indicator(1),
      T => '1'
    );
\up_request_indicator_OBUF[2]_inst\: unisim.vcomponents.OBUFT
     port map (
      I => '0',
